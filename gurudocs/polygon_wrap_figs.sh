...
# It uses the two files test_polygon_lonlat.txt and test_polygon_xy_J[MH].txt
#
# test_polygon_xy_J[MH].txt were produced by running 
# gmt psxy -R0/360/0/90 -JH180/6i -P -Baf test_polygon_lonlat.txt -Gred > o.ps
# gmt psxy -R180/180/15/65 -JM0/6i -P -Baf test_polygon_lonlat.txt -Gred > o.ps
...
# Create the left-warpped and right-wrapped polygons
...
gmt psconvert pwrap_JH_?.ps -Tf -P -A -Z
rm -f L.txt R.txt
