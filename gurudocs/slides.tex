...
in between we require it to be a monotonically increasing curve (e.g., linear ($\beta = 1$)).  This means that, for some time $t$, the actual
...
\end{equation}
which, for $p = 2$, yields a parabolic function. The normalized angle $\gamma$ over the range $\pm1$ is defined as
\begin{equation}
